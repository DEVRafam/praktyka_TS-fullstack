<template>
    ...
    <!--  -->
    <div class="content-wrap" :class="{ active: currentState === 'editing', show: showForm }">
...
import { currentState, showForm } from "@/composable/profile/useMyOpinion";
//
